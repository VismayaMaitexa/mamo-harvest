# Generated by Django 5.1.1 on 2024-12-26 10:34
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('harvest', '0004_alter_feedback_rating'),
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='booking',
            name='products',
            field=models.ManyToManyField(blank=True, related_name='orders', to='harvest.product'),
        ),
        migrations.AddField(
            model_name='booking',
            name='status',
